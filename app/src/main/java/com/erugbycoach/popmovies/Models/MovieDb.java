...
import com.erugbycoach.popmovies.DB.MovieContract;
...
public class MovieDb implements Parcelable {
    ...
    public static MovieDb getMovieFromJson(JSONObject jsonObject) throws JSONException {
    ...
    public boolean saveToFavourite(Context context) {
